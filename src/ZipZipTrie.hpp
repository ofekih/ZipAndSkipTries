...
template <typename CHAR_T, typename LCP_T, unsigned CHAR_SIZE_BITS = sizeof(CHAR_T) * 8>
class ZipZipTrie : public GeneralizedZipTrie<CHAR_T, GeometricRank, LCP_T, CHAR_SIZE_BITS>
{
public:
	ZipZipTrie(unsigned max_size, LCP_T max_lcp_length) : GeneralizedZipTrie<CHAR_T, GeometricRank, LCP_T, CHAR_SIZE_BITS>(max_size, max_lcp_length) {}
